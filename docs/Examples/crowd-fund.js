...
// Step 2: Add an output with the target amount you would like to raise and an address you control
const fundeeWallet = await new bcoin.http.Wallet({ id: 'foo', network: 'testnet'});
